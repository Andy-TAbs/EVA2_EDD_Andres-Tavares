 ...
 * @author mague
 */
public class ListaQueue { //LISTA SIMPLEMENTE ENLAZADA (LINKED LIST)
   private NodoQueue inicio;//Acceso a mi lista, punto de partida
    private NodoQueue Fin;
    ...
    public void add(int Valor){
        NodoQueue Nuevo = new NodoQueue(Valor);
    ...
    public void printList(){
           NodoQueue temp = inicio;//aqui empezamos
           //WHILE
    ...
    public void insertAtBeginning(NodoQueue Nuevo){
