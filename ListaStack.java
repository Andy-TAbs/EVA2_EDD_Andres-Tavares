 ...
 * @author mague
 */
public class ListaStack { //LISTA SIMPLEMENTE ENLAZADA (LINKED LIST)
   private NodoStack inicio;//Acceso a mi lista, punto de partida
    ...
    public void add(int Valor){
        NodoStack Nuevo = new NodoStack(Valor);
    ...
    public void printList(){
           NodoStack temp = inicio;//aqui empezamos
           //WHILE
    ...
    public void insertAtBeginning(NodoStack Nuevo){
